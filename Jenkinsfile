    ...
    stages {
        ...
        stage('RLTest') {
            steps {
                ...
                sh '/bin/RLSecure/rl-secure report -s /bin/RLSecure -p WebApps/struts2-showcase@v2.5.28_$BUILD_NUMBER --format cyclonedx,rl-html,rl-json --output-path $WORKSPACE/RLreports/$BUILD_NUMBER'
